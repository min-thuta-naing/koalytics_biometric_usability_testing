...
import { Menu, Info, FolderOpenDot, LogOut, Bell, CircleUserRound } from "lucide-react";
...
{isSwitching ? (
                <div className="fixed inset-0 flex items-center justify-center bg-gradient-to-br from-purple-600 via-blue-600 to-green-600 animate-gradient-move">
                    <h1 className="text-4xl font-funnel font-bold text-white animate-fade-in">Switching to Participant Home ...</h1>
                </div>
            ) : (
                <>
      ...
      <div className="fixed w-full bg-transparent p-4 pl-8 flex justify-between items-center">
          ...
          <div className="flex items-center gap-6">
            ...
            <CircleUserRound size={24} className="cursor-pointer" onClick={() => navigate("/my-account")} />
          </div>
        </div>
      ...
      {/* Main Content */}
      <div className={`flex-1 flex flex-col transition-all duration-300 ease-in-out ${isCollapsed ? "ml-20" : "ml-48"}`}>
