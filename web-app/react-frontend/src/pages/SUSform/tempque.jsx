...
const CreateSUSQuestion = () => {
    return (
        <div className="grid grid-cols-3 gap-5 p-5 h-[400px]">
            {/* Nested grid container - takes full height */}
            <div className="grid gap-5 h-full">
                <div className="bg-red-100 flex items-center justify-center p-4 h-full rounded-lg shadow-lg">1.1</div>
                <div className="bg-red-100 flex items-center justify-center p-4 h-full rounded-lg shadow-lg">1.2</div>
            </div>
            <div className="bg-red-100 flex items-center justify-center p-4 rounded-lg shadow-lg">02</div>
            <div className="bg-red-100 flex items-center justify-center p-4 rounded-lg shadow-lg">03</div>
        </div>
    )
  };
