            ...
            <div className="flex flex-col h-full relative">
              ...
              <nav className="space-y-2 flex-grow mt-20">
                <button
                  ...
                  className={`flex items-center p-2 w-full rounded-lg hover:bg-[#ACA3E3] cursor-pointer transition-all duration-300 ease-in-out ${
                    activePage === "projects" ? "bg-gray-300 border border-gray-400" : ""
                  }`}
                >
                ...
                <button
                  ...
                  className={`flex items-center p-2 w-full rounded-lg hover:bg-[#ACA3E3] cursor-pointer transition-all duration-300 ease-in-out ${
                    activePage === "profile" ? "bg-gray-300 border border-gray-400" : ""
                  }`}
                >
                  <User size={20} />
                  {showText && <span className="ml-3 text-sm">My Profile</span>}
                </button>

                <button
                  onClick={() => setActivePage("guideline")}
                  className={`flex items-center p-2 w-full rounded-lg hover:bg-[#ACA3E3] cursor-pointer transition-all duration-300 ease-in-out ${
                    activePage === "guideline" ? "bg-gray-300 border border-gray-400" : ""
                  }`}
                >
                  <Info size={20} />
              ...
              <div className="flex flex-col items-left mt-auto">
                ...
                <div
                  ...
                  className="flex items-center p-2 rounded-lg hover:bg-red-300 cursor-pointer transition-all duration-300 ease-in-out z-[9999]"
                >
                  <LogOut size={20} />
